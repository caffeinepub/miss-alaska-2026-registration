...
import type { ExternalBlob as _ExternalBlob, Registration as _Registration, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllRegistrationsSortedByTimestamp(): Promise<Array<Registration>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllRegistrationsSortedByTimestamp();
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRegistration(arg0: RegistrationId): Promise<Registration> {
        if (this.processError) {
            try {
    ...
    async submitRegistration(arg0: Registration): Promise<RegistrationId> {
        if (this.processError) {
            try {
                const result = await this.actor.submitRegistration(await to_candid_Registration_n18(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    fullName: string;
    talentSkills: string;
    fullBodyPhotoBlob: [] | [_ExternalBlob];
    address: string;
    occupationOrSchool: string;
    timestamp: bigint;
    emergencyContactPhone: string;
    ...
    return {
        ...
        bust: value.bust,
        hips: value.hips,
        bioPlatformStatement: value.bioPlatformStatement,
        fullName: value.fullName,
        talentSkills: value.talentSkills,
        fullBodyPhotoBlob: record_opt_to_undefined(await from_candid_opt_n13(_uploadFile, _downloadFile, value.fullBodyPhotoBlob)),
        address: value.address,
        occupationOrSchool: value.occupationOrSchool,
        timestamp: value.timestamp,
        emergencyContactPhone: value.emergencyContactPhone,
        previousPageantExperience: value.previousPageantExperience,
        contactNumber: value.contactNumber,
        emergencyContactName: value.emergencyContactName,
        headshotBlob: record_opt_to_undefined(await from_candid_opt_n13(_uploadFile, _downloadFile, value.headshotBlob)),
        waist: value.waist,
        hobbiesInterests: value.hobbiesInterests,
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Registration>): Promise<Array<Registration>> {
...
async function to_candid_Registration_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Registration): Promise<_Registration> {
...
async function to_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        fullName: value.fullName,
        talentSkills: value.talentSkills,
        fullBodyPhotoBlob: value.fullBodyPhotoBlob ? candid_some(await to_candid_ExternalBlob_n20(_uploadFile, _downloadFile, value.fullBodyPhotoBlob)) : candid_none(),
        address: value.address,
        occupationOrSchool: value.occupationOrSchool,
        timestamp: value.timestamp,
        emergencyContactPhone: value.emergencyContactPhone,
        ...
        contactNumber: value.contactNumber,
        emergencyContactName: value.emergencyContactName,
        headshotBlob: value.headshotBlob ? candid_some(await to_candid_ExternalBlob_n20(_uploadFile, _downloadFile, value.headshotBlob)) : candid_none(),
        waist: value.waist,
        hobbiesInterests: value.hobbiesInterests,
        educationLevel: value.educationLevel
    };
